...
上级：[[MOC-学习路线]]
来源文件：`docs/learning/00-project-overview.md`
...
1. 系统地图：[[00-project-overview]] + [[架构图-Mermaid版]]
...
4. 集群与运维：[[09-cluster-mode-and-role-wiring]] -> [[10-cluster-scheduler-lease-and-heartbeat]] -> [[11-cluster-api-and-frontend-observability]] -> [[07-tests-and-safety]] -> [[12-e2e-and-release-practice]] -> [[08-orchestrator-discovery]]
