...
// input: standalone startup with persisted RUNNING task metadata and injected runner dependencies
// output: regression coverage proving active tasks resume automatically after process restart
