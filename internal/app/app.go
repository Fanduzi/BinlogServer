...
// output: role-aware application lifecycle control with production control-plane auth checks, metadata/source isolation, worker-scoped restart recovery, expired-lease claim, and shutdown
