...
// input: API Swagger annotations and domain response models
// output: embedded Swagger 2.0 document metadata for the API documentation handler
// pos: generated API contract artifact consumed by internal/api
