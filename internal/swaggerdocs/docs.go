...
// input: Swagger annotations and API contract types from internal/api
// output: embedded OpenAPI metadata including cluster overview/workers 500 and the task batch endpoint
// pos: generated API documentation consumed by the Swagger handler
// note: if this file changes, update this header and internal/swaggerdocs/README.md.
package swaggerdocs
    ...
    "paths": {
        ...
        "/api/tasks": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Filter by task state (CREATED, STARTING, RUNNING, LEASE_DEGRADED, REBUILDING_FILE, RETRY_BACKOFF, FAILED, STOPPING, STOPPED)",
                        "name": "state",
                        "in": "query"
                    },
                    {
        ...
        "/api/tasks/batch": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Batch task create payload (1-100 items)",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/api.batchCreateRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/api.batchCreateResult"
                            }
                        }
                    },
                    "400": {
